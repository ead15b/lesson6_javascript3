...
function previewFive() {
    //locate first element where the atg is article assign to a variable 
    var articleEl = document.getElementsByTagName("article")[0];
   //create figure and img elements fo fifth image var last figure = document.createElement("figure");
   lastFigure.id= "flg5";
...
//add or attach the fifth image to preview lastFigure.appendChild(lastImage);
...
//add appropriate src values to twonew img elements
document.getElementsByTagName("img")[0].src= "images/IMG_0"+ photoOrder[0]+ "sm.jpg";
document.getElementsByTagName("img")[4].src= "images/IMG_0"+ phootoOrder[4]+ "sm.jpg";

figure count=5
//disable the 'show more images' button after it has been selected once var numberButton= document.querySelector("#liveButton p");
...
//when the user clicks the Show more button the previewFive function is executed showAllButton.addEventListener("click", previewFive, false);
